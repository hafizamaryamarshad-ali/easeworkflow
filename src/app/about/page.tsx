    ...
    <div style={{ 
      ...
      <section style={{ maxWidth: "1200px", margin: "0 auto 100px", padding: "0 20px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "30px" }}>
          {[
            { title: "Our Mission", icon: <FaRocket />, text: "EaseWorkflow’s mission is to simplify and modernize healthcare operations by delivering intelligent, reliable, and user-centered digital solutions that reduce administrative burden and improve patient care outcomes. We aim to bridge the gap between complex medical workflows and efficient technology by providing tools that seamlessly integrate into existing healthcare systems. Our focus is to empower hospitals, clinics, and healthcare professionals with automation, data-driven insights, and secure platforms that enhance decision-making and operational efficiency. We are committed to improving accessibility, reducing human error, and saving valuable time for medical staff so they can focus more on patient care rather than administrative tasks. Through continuous innovation, we strive to build scalable solutions that adapt to the evolving needs of the healthcare industry. Our mission also emphasizes compliance, data security, and ethical AI usage, ensuring that all systems meet international healthcare standards. By prioritizing user experience and real-world applicability, EaseWorkflow aims to become a trusted partner in transforming healthcare workflows into faster, smarter, and more efficient processes that ultimately lead to better patient outcomes and a healthier society." },
            { title: "Our Vision", icon: <FaEye />, text: "EaseWorkflow envisions a future where healthcare systems operate with complete digital intelligence, where every process—from patient registration to treatment and follow-up—is seamlessly connected, automated, and optimized. Our vision is to create a globally recognized healthcare technology ecosystem that eliminates inefficiencies, minimizes manual errors, and enhances collaboration among healthcare providers. We aspire to be at the forefront of innovation by integrating advanced technologies such as artificial intelligence, machine learning, and data analytics into everyday healthcare operations. Our long-term goal is to transform traditional healthcare environments into smart, adaptive systems that can predict needs, streamline workflows, and improve patient outcomes in real time. EaseWorkflow envisions a world where healthcare professionals are fully supported by intelligent systems that reduce workload and enable faster, more accurate decisions. We aim to expand globally while maintaining strict standards of privacy, security, and ethical responsibility. Ultimately, our vision is not just to build software, but to redefine how healthcare systems function—making them more efficient, more intelligent, and more patient-centric, leading to a future where quality healthcare is accessible, efficient, and consistently reliable for everyone." }
          ].map((card, i) => (
