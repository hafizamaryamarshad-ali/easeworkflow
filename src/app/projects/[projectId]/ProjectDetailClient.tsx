...
const projectResources: Record<string, { caseStudy: string; article: string }> = {
  "medical-document-upload-automation": {
    caseStudy: "/case-studies/medical-document-upload-automation-case-study",
    article: "/blog/medical-document-upload-automation",
  },
  "insurance-eligibility-verification-automation": {
    caseStudy: "/case-studies/insurance-eligibility-verification-automation-case-study",
    article: "/blog/insurance-verification-clinic-delay",
  },
  "automated-patient-registration-appointment-emr-automation": {
    caseStudy: "/case-studies/emr-patient-automation-case-study",
    article: "/blog/emr-automation-clinic-operations",
  },
  "telemedicine-appointment-encounter-automation": {
    caseStudy: "/case-studies/telemedicine-encounter-automation-case-study",
    article: "/blog/telemedicine-workflow-automation",
  },
  "insurance-pharmacy-data-extraction-automation": {
    caseStudy: "/case-studies/insurance-pharmacy-data-extraction-automation-case-study",
    article: "/blog/healthcare-data-extraction",
  },
  "ai-soap-notes-automation-emr-integration": {
    caseStudy: "/case-studies/ai-soap-notes-entry-automation-case-study",
...
export default function ProjectDetailClient({ initialProject }: { initialProject: Project }) {
  ...
  useEffect(() => {
    ...
    const loadProject = async () => {
      if (initialProject && (initialProject.slug === projectSlug || initialProject._id === projectSlug)) {
        return;
      }
      if (!projectSlug) {
        if (isMounted) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <nav aria-label="Related project resources" style={{ marginTop: "32px", lineHeight: 1.8 }}>
          <strong>Related resources: </strong>
          <Link href="/services-details">healthcare automation services</Link>
          {projectResources[project.slug] && (
            <>
              {" · "}<Link href={projectResources[project.slug].caseStudy}>view the related case study</Link>
              {" · "}<Link href={projectResources[project.slug].article}>read the workflow guide</Link>
            </>
          )}
